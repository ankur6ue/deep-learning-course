...
for epoch in range(epochs):
    # This puts the model in a training state.. affects dropout and batch normalization layers
    model.train()
    # Set the gradients to 0, otherwise gradients will be accumulated!
    optimizer.zero_grad()
    # Forward pass
...
# 5. Plot predictions
model.eval()
# Generate test data.. note: test data is in the same range as training data.. what if it is not? Try it!
