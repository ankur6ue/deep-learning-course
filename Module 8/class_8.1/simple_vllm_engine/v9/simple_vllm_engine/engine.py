...
class DecodeGpuState:
    ...
    def __init__(self, *, max_num_reqs: int, device: torch.device, enabled: bool) -> None:
        ...
        # these values to gather/scatter rows in `last_token_ids` and, in v9,
        # gather request block-table rows. Reusing one buffer avoids allocating
        # a new tiny CUDA tensor every decode step.
