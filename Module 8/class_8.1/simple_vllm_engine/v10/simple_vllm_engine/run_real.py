...
SETTINGS = VersionSettings(
    version_name='v10_architecture_adapters_gemma4',
    version_topic='Architecture adapters with Gemma 4 text support',
    ...
    attention_backend_choices=('triton_paged', 'flash_attn_paged'),
