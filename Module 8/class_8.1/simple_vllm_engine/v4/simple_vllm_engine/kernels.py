...
class TritonDecodeMetadata:
    """Reusable metadata for single-token paged decode attention."""
...
def describe_kernel_stack(device: str) -> str:
    ...
    if device.startswith("cuda"):
        return ('Linear layers dispatch GEMM kernels via PyTorch/cuBLAS, while FlashAttention varlen handles paged prefill/decode attention directly from block tables.')
