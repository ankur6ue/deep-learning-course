...
- `model.py`: a compact Llama-style decoder with explicit KV-cache hooks
...
```bash
python "/home/ankur/dev/deep-learning-course/Module 10/class_10.1/v1/simple_vllm_engine/bench.py" --device cuda
```

CPU also works for smoke testing:

```bash
python "/home/ankur/dev/deep-learning-course/Module 10/class_10.1/v1/simple_vllm_engine/bench.py" --device cpu
```
